...
public class Evenement {
    ...
    private DateTimeSpinner date_e;
    ...
    private DateTimeSpinner date_modif;
    ...
    public DateTimeSpinner getDate_e() {
        return date_e;
    }

    public void setDate_e(DateTimeSpinner date_e) {
        this.date_e = date_e;
    }

    public DateTimeSpinner getDate_modif() {
        return date_modif;
    }

    public void setDate_modif(DateTimeSpinner date_modif) {
    ...
    public Evenement(String titre_e, String desc_e, DateTimeSpinner date_e, int id_user, String usr_role, int idClub, String image, String type_e, String googlemaps) {
        this.titre_e = titre_e;
        this.desc_e = desc_e;
        this.date_e = date_e;
        this.id_user = id_user;
