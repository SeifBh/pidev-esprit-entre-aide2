...
//}
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        annonces=annonceTool.afficherAnnonce();
...
//            P4.setVisible(false);
    ...
    private void searchUpdate() {
        annonces=annonceTool.getAnnonce(tfSearch.getText());
        System.out.println(annonces.size()+"hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh");
        String newValue=pageNumber.getText();
          if (Integer.parseInt(newValue) == 0) {
