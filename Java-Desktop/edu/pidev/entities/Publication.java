...
public class Publication {
    ...
    public Publication(int id, int user_id, String desc_p) {
        this.id = id;
...
//    }
    ...
    public Publication(int id, int user_id, String desc_p, Timestamp date_p, Date date_modif, String image, String tags) {
        this.id = id;
        this.user_id = user_id;
        this.desc_p = desc_p;
        this.date_p = date_p;
    ...
    public Publication(int id , String image, String tags) {
                this.id = id;
                this.image = image;
                this.tags = tags;
